...
public class SoundtrackToLife {
	...
	public static void main(String[] args) {
		...
		int userMood = JOptionPane.showOptionDialog(null, "The question", "Pop-up Title", 0,
				JOptionPane.INFORMATION_MESSAGE, null, new String[] { "Chill", "notChill", "cheerMeUp" }, null);
...
if(userMood == 0) {
	playVideo("https://www.youtube.com/watch?v=gwDoRPcPxtc");
	
}

if(userMood == 2) {
	playVideo("https://www.youtube.com/watch?v=l4WNrvVjiTw");
